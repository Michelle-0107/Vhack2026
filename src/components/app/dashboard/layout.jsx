...
/**
 * ROOT LAYOUT - THE COMMANDER'S FOUNDATION
 * This file handles the global tactical styles, custom scifi fonts, 
 * and critical HUD animations.
 */
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        <title>BEACON-NET · HITL Command v4.2</title>
        <meta name="description" content="Decentralized drone swarm command interface." />
        
        {/* Loading Tactical Fonts: Orbitron (Branding) & Share Tech Mono (Data) */}
      ...
      {/* The Body: 
        1. margin:0 / padding:0 ensures the UI touches the screen edges.
        2. overflow:hidden prevents accidental scrolling on your radar.
      */}
      <body 
      ...
      >
        {/* Tactical Animation Engine: Global Keyframes for your 18 components */}
        <style dangerouslySetInnerHTML={{ __html: `
          * { box-sizing: border-box; margin: 0; padding: 0; }
          
          /* Tactical Scrollbar (Cyberpunk Style) */
          ::-webkit-scrollbar { width: 3px; }
          ::-webkit-scrollbar-track { background: #010810; }
          ::-webkit-scrollbar-thumb { background: #00f5ff22; border-radius: 2px; }

          /* Global Command Animations */
        ...
        {/* This is where your app/page.js content (The HUD) will render */}
        {children}
      </body>
    </html>
  );

...
const useFleetStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        deployUnit: ()=>{
            ...
            const battery = Math.floor((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rnd"])(55, 92));
            const sig = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SIGS"][Math.floor(Math.random() * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SIGS"].length)];
            const newDrone = {
                id: newId,
                name,
                battery,
            ...
            pushLog((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("MANUAL", `[HUMAN] ${newId} (${name}) manually deployed. Survivor sighting at grid ${Math.floor((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rnd"])(10, 99))}-X.`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("COT", `CoT: Detected new node ${newId} inserted by operator. Re-computing mesh coverage...`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("ANALYSIS", `Mesh expanded: +${Math.floor((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rnd"])(12, 22))}% coverage area. Relay path updated.`));
            setTimeout(()=>set({
                    flashDeploy: false
                }), 800);
            setTimeout(()=>set((s)=>{
        ...
        recallUnit: (id)=>{
            ...
            pushLog((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("RECALL", `[HUMAN] RECALL issued: ${id} (${drone.name}). Battery: ${drone.battery}%. RTB initiated.`));
            setTimeout(()=>{
                set((s)=>{
                    ...
                    if (drone.isRelay && remaining.length >= 2) {
                        ...
                        const target = {
                            x: (drone.x + healer.x) / 2 + (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rnd"])(-8, 8),
                            y: (drone.y + healer.y) / 2 + (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rnd"])(-8, 8)
                        };
                        ...
                        setTimeout(()=>{
                            get().pushLog((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("HEAL", `SELF-HEAL COMPLETE: ${healer.id} reached gap position. Mesh signal restored. Coverage: ${Math.floor((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rnd"])(94, 100))}%.`));
                        }, 4200);
                        extraLogs = [
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("COT", `CoT: ${id} removed. Analyzing coverage gap at (${drone.x.toFixed(0)},${drone.y.toFixed(0)})...`),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("COT", `CoT: Nearest relay candidate: ${healer.id} (${healer.name}). Distance: ${Math.sqrt((healer.x - drone.x) ** 2 + (healer.y - drone.y) ** 2).toFixed(1)} units.`),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("DECISION", `AI: Repositioning ${healer.id} → gap sector. Promoting to RELAY node.`),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("ACTION", `Transmitting new waypoint to ${healer.id}. ETA: ${Math.floor((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rnd"])(18, 40))}s.`)
                        ];
                        ...
                        extraLogs = [
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("COT", `CoT: ${id} removed. Non-relay unit — no coverage gap detected.`),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("ANALYSIS", `Mesh integrity maintained. ${remaining.length} nodes active.`)
                        ];
                        const newRecalling = new Set(s.recalling);
                        newRecalling.delete(id);
                        return {
        ...
        toggleMode: (id)=>{
            ...
            pushLog((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])(newMode === "MANUAL" ? "MANUAL" : "ACTION", `${id} mode → ${newMode}. ${newMode === "MANUAL" ? "Human operator assumed control." : "Returned to AI autonomy."}`));
        },
        // ─── SUBMIT INTEL ─────────────────────────────────────────────────────────
        submitIntel: ()=>{
            const { intelText, drones, pushLog } = get();
            if (!intelText.trim()) return;
            pushLog((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("PROMPT", intelText.trim()), (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("COT", `CoT: Processing operator intel. Cross-referencing with swarm telemetry, thermal data, and grid map...`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeLog"])("ACTION", `Intel logged. Adjusting patrol priorities for ${drones.length} active units.`));
            set({
                intelText: ""
            });
        },
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                ].map(({ icon, k, v })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            display: "flex",
                            alignItems: "center",
                            gap: 3,
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            ...
                            boxShadow: `0 0 16px ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CRIT_RED"]}77`
                        }
                    }, void 0, false, {
                        fileName: "[project]/src/components/map/ThermalZone.jsx",
                        lineNumber: 25,
...
function MapGrid() {
    ...
    const setActiveDrone = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useFleetStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFleetStore"])((s)=>s.setActiveDrone);
    const toggleMode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useFleetStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFleetStore"])((s)=>s.toggleMode); // Added: Logic to switch modes
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        style: {
                            ...
                            border: `1px solid ${activeDrone ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HUMAN_MAG"] : "#444"}`,
                            color: activeDrone ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HUMAN_MAG"] : "#666",
                            padding: "8px 20px",
                            borderRadius: 4,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        style: {
                            ...
                            alignItems: "center",
                            gap: 8,
                            boxShadow: `0 0 15px ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AI_CYAN"]}55`
                        },
                        children: [
